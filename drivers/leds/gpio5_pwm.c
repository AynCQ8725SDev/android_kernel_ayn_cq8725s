...
static ssize_t state_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t len)
{
	if (sysfs_streq(buf, "1"))
	{
		...
		gpio_set_value(data->fan_en_gpio,1);
	...
	else if (sysfs_streq(buf, "0"))
	{
		...
		gpio_set_value(data->fan_en_gpio,0);
...
static ssize_t duty_show(const struct class *class,const struct class_attribute *attr, char *buf)
{
	return (sprintf(buf, "%u\n", data->duty_ns));
}

static ssize_t duty_store(const struct class *class,const struct class_attribute *attr, const char *buf, size_t len)
{
	int rc;
...
static ssize_t thermal_show(const struct class *class,const struct class_attribute *attr, char *buf)
{
	return (sprintf(buf, "%u\n", thermal_mode));
}

static ssize_t thermal_store(const struct class *class,const struct class_attribute *attr, const char *buf, size_t len)
{
	int rc;
...
static ssize_t en_backlight_show(const struct class *class,const struct class_attribute *attr, char *buf)
{
	return (sprintf(buf, "%u\n", en_backlight));
}

static ssize_t en_backlight_store(const struct class *class,const struct class_attribute *attr, const char *buf, size_t len)
{
	int rc;
...
static ssize_t dp_state_show(const struct class *class,const struct class_attribute *attr, char *buf)
{
...
static ssize_t dp_state_store(const struct class *class,const struct class_attribute *attr, const char *buf, size_t len)
{
	int rc;
...
static ssize_t hdmi_state_show(const struct class *class,const struct class_attribute *attr, char *buf)
{
...
static ssize_t hdmi_state_store(const struct class *class,const struct class_attribute *attr, const char *buf, size_t len)
{
	int rc;
...
static ssize_t period_show(const struct class *class,const struct class_attribute *attr, char *buf)
{
	return (sprintf(buf, "%u\n", data->period_ns));
}

static ssize_t period_store(const struct class *class,const struct class_attribute *attr, const char *buf, size_t len)
{
	int rc;
...
static ssize_t speed_show(const struct class *class,const struct class_attribute *attr, char *buf)
{
...
static int gpio5_pwm_probe(struct platform_device *pdev)
{
	...
	data->pwm_dev = devm_pwm_get(&pdev->dev,NULL);
	if (!data->pwm_dev)
	{
