...
#define MCU_PWR				(512+83) // GPIO_83
#define MCU_BOOT			(1210) // GPIO_110
#define MCU_RESET			(333+6) // GPIO_6
#define MCU_UART_PWR		(512+85) // GPIO_85
...
#define driver_printk(level, format, args...)  \
			do{ \
				printk(level "Odin3 msm-kernel[%s(%d)]" format, \
